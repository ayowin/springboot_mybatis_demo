...
MySQL - 5.5.58 : Database - springboot_mybatis_demo
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`springboot_mybatis_demo` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `springboot_mybatis_demo`;
